...
class cv_yolo_ros():
    def __init__(self):
        ...
        self.flag = False
        self.inference_rate = rospy.get_param("/inference_rate", 50)
        self.inference_img_size = rospy.get_param("/inference_img_size", 640)
        self.img_in_topic = rospy.get_param("/img_in_topic", "/thermal_image")
        self.img_out = rospy.get_param("/img_out", True)
        self.img_out_topic = rospy.get_param("/img_out_topic", "/detect_thermal_image")
        ...
        self.weight_file = rospy.get_param("/weight_file", "yolov7-tiny.weights")
        self.cfg_file = rospy.get_param("/cfg_file", "yolov7-tiny.cfg")
